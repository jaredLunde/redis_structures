...
class TestPickledRedisDefaultHash(TestJSONRedisDefaultHash):
    hash = RedisDefaultHash(
        "pickled_hash", prefix="rs:unit_tests:", serializer=pickle)
...
class TestUnserializedRedisDefaultHash(TestJSONRedisDefaultHash):
    hash = RedisDefaultHash("unserialized_hash", prefix="rs:unit_tests:")
    is_str = True
